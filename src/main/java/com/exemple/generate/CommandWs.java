...
public interface CommandWs {
    ...
    @WebMethod
    @WebResult(partName = "return")
    @Action(input = "http://command_web_service.example.com/CommandWs/getListOfGroupUsersRequest", output = "http://command_web_service.example.com/CommandWs/getListOfGroupUsersResponse")
    public ListOfString getListOfGroupUsers(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
